...
void	wr_prl_st(t_list *lst1, t_list *lst2);	//Функция для печати контента стеков параллельно в два столбика. Удалить при публикации
void	wr_st(t_list *lst);	//Функция для печати контента стека. Удалить при публикации
void	wr_2st_str(t_list *lst1, t_list *lst2);	//Функция для печати контента стеков в строку. Удалить при публикации
...
void	chk_op(t_vrb *vr, enum Ops *op); //Чекер - принимает команду, меняет элементы в стеках, и чекает, соответствует ли это оригинальным стекам
...
void	ft_pushswap4_3(t_vrb *vr, enum Ops op);
